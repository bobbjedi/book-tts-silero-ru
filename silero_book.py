#!/usr/bin/env python3
"""TXT → WAV через Silero: чанки ~900 символов, склейка ffmpeg. Опционально *слово* перед ?."""
...
def concat_wavs(parts: list[Path], out_path: Path, tmp_dir: Path) -> None:
